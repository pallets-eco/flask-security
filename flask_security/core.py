...
_default_messages = {
    ...
    "DISABLED_ACCOUNT": (_("Invalid Username or Password"), "error"),
    ...
    "USER_DOES_NOT_EXIST": (_("Invalid Username or Password"), "error"),
    "INVALID_PASSWORD": (_("Invalid Username or Password"), "error"),
