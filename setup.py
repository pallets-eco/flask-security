...
setup(
    ...
    extras_require={
        'dev': [
            ...
            'pre-commit>=1.16', 'pydocstyle>=3.0.0', 'pymysql>=0.9.3',
            ...
            'tox>=3.12', 'werkzeug>=0.12.2'
        ],
        'tests': [
            'babel>=1.3', 'bcrypt>=3.1', 'check-manifest>=0.25',
            'coverage>=4.0', 'cryptography>=2.3.0,>=2.7', 'flask-cli>=0.4.0',
            'flask-mongoengine>=0.9.5', 'flask-peewee>=3.0',
            'flask-sphinx-themes>=1.0.1', 'flask-sqlalchemy>=2.3',
            'isort>=4.2.2', 'mock>=1.3.0', 'mongoengine>=0.12.0',
            'mongomock>=3.14.0', 'msgcheck>=3.0', 'pony>=0.7.4',
            'pydocstyle>=3.0.0', 'pymysql>=0.9.3', 'pyqrcode>=1.2',
            ...
            'sqlalchemy-utils>=0.33.0', 'tomlkit>=0.5.3', 'werkzeug>=0.12.2'
        ],
        'docs': [
