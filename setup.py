...
setup(
    ...
    extras_require={
        'dev': [
            ...
            'flask-peewee>=3.0', 'flask-sphinx-themes>=1.0.1',
            'flask-sqlalchemy>=2.4', 'isort>=4.2.2', 'mock>=1.3.0',
            'mongoengine>=0.12.0', 'mongomock>=3.16', 'msgcheck>=3.0',
            'pony>=0.7.4', 'pre-commit>=1.16', 'pydocstyle>=3.0.0',
